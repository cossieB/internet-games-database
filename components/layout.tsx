        ...
        <nav>
            ...
            <Link href={'/games'} >
                <a>
                    <div>
                        <span className="navIcon" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-dice-6-fill" viewBox="0 0 16 16">
                        ...
                        <span className="navText" >Games</span>
                    </div>
                </a>
            </Link>
            ...
            <Link href={'/publishers'} >
                <a>
                    <div>
                        ...
                        <span className="navText" >Publishers</span>
                    </div>
                </a>
            </Link>
        </nav>
